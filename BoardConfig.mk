...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt $(OUT_DIR)/target/product/on7xelte/obj/KERNEL_OBJ/arch/$(TARGET_ARCH)/boot/dtb.img
